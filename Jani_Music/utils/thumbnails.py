...
async def get_thumb(videoid):
    ...
    try:
        ...
        # Fonts
        arial = ImageFont.truetype("Jani_Music/assets/font2.ttf", 30)
        font = ImageFont.truetype("Jani_Music/assets/font.ttf", 30)
        bold_font = ImageFont.truetype("Jani_Music/assets/font.ttf", 33)
