...
#BOT FILE NAME
from Jani_Music import app as app
from Jani_Music.mongo.couples_db import _get_image, get_couple
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "Jani_Music/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "Jani_Music/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("Jani_Music/assets/cppic.png")
