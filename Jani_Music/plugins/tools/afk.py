...
from Jani_Music.mongo.readable_time import get_readable_time
from Jani_Music.mongo.afkdb import add_afk, is_afk, remove_afk
import random 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup

NEXIO = [
        [
            InlineKeyboardButton(text="• ᴀᴧᴅᴅ ϻᴇ ʙᴧʙʏ •", url=f"https://t.me/Sizzumusicbot?startgroup=true"),
        ],
        ]
