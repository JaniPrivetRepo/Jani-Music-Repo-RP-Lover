...
from Jani_Music.utils.decorators.language import language
from Jani_Music.utils.inline import supp_markup
from Jani_Music.utils.inline import close_markup
...
async def ping_com(client, message: Message, _):
    ...
    reply_markup=InlineKeyboardMarkup(
        ...
        [
            InlineKeyboardButton(
                text="⌯ sᴜᴘᴘᴏʀᴛ ⌯", url=f"https://t.me/Selfish_Jani_Lover",
            ),
            InlineKeyboardButton(
                text="⌯ ᴜᴘᴅᴀᴛᴇ ⌯", url=f"https://t.me/Power_of_Jani",
            )
        ],
        [
            InlineKeyboardButton(
